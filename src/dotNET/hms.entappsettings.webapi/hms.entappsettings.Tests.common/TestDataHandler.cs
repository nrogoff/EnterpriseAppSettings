...
namespace hms.entappsettings.Tests.common
{
    /// <summary>
    ...
    {
        /// <summary>
        /// NOTE: Set this to true once to clear the test database if it's flagging as populated
        /// BE REALLY SURE YOU HAVE THE RIGHT DATABASE CONNECTION STRING!!
        /// </summary>
        public bool ForceInitialClearDownOfDb { get; set; }
