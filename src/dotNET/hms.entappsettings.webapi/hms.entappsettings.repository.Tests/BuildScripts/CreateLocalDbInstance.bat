...
sqlcmd -S "(localdb)\MSSQLLocalDB" -Q "EXEC sys.sp_configure N'contained database authentication', N'1';"
sqlcmd -S "(localdb)\MSSQLLocalDB" -Q "RECONFIGURE WITH OVERRIDE;"
REM --- 5 sec delay
